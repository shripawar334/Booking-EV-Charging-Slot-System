      ...
      <div className="max-w-md w-full">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl font-bold border-l-4 border-purple-500 pl-3">Create account</h1>
            <p className="text-gray-300">Join EV App and start your journey.</p>
          </div>
          ...
          <div className="text-sm text-gray-400 text-center">
            ...
            <Link href="/login" className="text-purple-400 hover:text-purple-300 underline">Sign in</Link>
          </div>
        </motion.div>
      </div>
    </div>
